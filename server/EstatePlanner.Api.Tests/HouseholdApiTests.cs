...
public class HouseholdApiTests(ApiFixture fixture) : IClassFixture<ApiFixture>
{
    ...
    public async Task Dashboard_reflects_net_estate_and_readiness()
    {
        ...
        // Empty household: only the household item is done (1 of 7)
        ...
        Assert.Equal(14, dashboard.ReadinessScore); // 1/7 rounded
        ...
        // household + family + assets + beneficiaries done = 4/7
        Assert.Equal(57, dashboard.ReadinessScore);
